...
local function get_jdtls_paths()
    ...
    local jdtls_install = '/Users/ktadesse1/Library/Java/jdt-language-server-1.42.0-202410312059'
    --                                  change here   ^^^^^^
...
local function jdtls_on_attach(client, bufnr)
    ...
    vim.api.nvim_exec_autocmds('LspAttach', { group = 'KirubelLspConfig', buffer = bufnr })
end


local function jdtls_setup(event)
    print("jdtls_setup called for buffer: " .. vim.api.nvim_get_current_buf())
    ...
    local cmd = {
        ...
        -- 💀
        '/Users/ktadesse1/Library/Java/JavaVirtualMachines/temurin-17.0.11/Contents/Home/bin/java', -- or '/path/to/java17_or_newer/bin/java'
